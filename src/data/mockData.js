...
maintenanceRecords: [
  ...
  {
    id: "ABIOT-SAFE-06",
    name: "Sterilizer 06 (Maternity Ward)",
    location: "Block D - Level 3 (Maternity)",
    department: "Maternity",
    status: "Offline",
    lastPacketReceived: "12 hours ago",
    ...
    cassetteId: "N/A",
    activeAlarmsCount: 0,
    serialNumber: "SN-E-SAFE-2023-0051X",
    procurementDate: "2023-04-10",
    installationDate: "2023-05-12",
    firmwareVersion: "v3.1.2",
    softwareVersion: "SmartTrace-Edge-v2.1",
    hospitalId: "HOSP-APOLLO-BG",
    gpsCoordinates: "12.9721° N, 77.5955° E",
    pumpHealth: 68,
    fanHealth: 72,
    motorHealth: 65,
    doorCycles: 5410,
    ...
    connectivityMode: "Wi-Fi (Disconnected)",
    signalStrength: "Offline",
    hardwareKeyId: "ATECC608A-ECDSA-KEY-0091",
    latestHashSignature: "N/A",
    totalOperatingHours: 4120,
    utilizationByRange: {
      '7d': { label: 'Last 7 Days', periodLabel: 'This Week', chartSubLabel: 'Daily', activeHours: 12.0, uptimePct: 20, data: [{ label: 'Mon', hoursActive: 4, cyclesRun: 5 }, { label: 'Tue', hoursActive: 8, cyclesRun: 10 }] }
    },
    downtimeRecords: [{ id: 'DT-2026-08', startTime: '2026-08-17 10:00', duration: '12h 00m', reason: 'Network Module Failure', resolvedBy: 'Pending', type: 'Unplanned' }],
    maintenanceRecords: [{ id: "MNT-2025-06", date: "2025-06-15", type: "Annual Calibration", engineer: "R. Sharma (ENG-02)", status: "PASSED", docName: "Calibration_Cert_2025.pdf" }]
  },
  {
    id: "ABIOT-SAFE-07",
    name: "Sterilizer 07 (New Annex)",
    location: "New Annex - Ground Floor",
    department: "General Wards",
    status: "Idle",
    lastPacketReceived: "10 sec ago",
    currentPhaseStep: 1,
    phase: "1. Ready for Load",
    temperature: 24.0,
    targetTemp: 0.0,
    ...
    wasteCategory: "None",
    currentBagId: "N/A",
    cassetteId: "CASS-H2O2-12",
    activeAlarmsCount: 0,
    serialNumber: "SN-E-SAFE-2026-0001N",
    procurementDate: "2026-08-15",
    installationDate: "2026-08-18",
    firmwareVersion: "v4.0.0-secure",
    softwareVersion: "SmartTrace-Edge-v3.0",
    hospitalId: "HOSP-APOLLO-BG",
    gpsCoordinates: "12.9730° N, 77.5960° E",
    pumpHealth: 100,
    fanHealth: 100,
    motorHealth: 100,
    doorCycles: 5,
    ...
    nextCalibrationDate: "2027-08-18",
    connectivityMode: "eSIM Cellular (5G)",
    signalStrength: "-55 dBm (Excellent)",
    hardwareKeyId: "ATECC608A-ECDSA-KEY-9999",
    latestHashSignature: "Pending Cycle",
    totalOperatingHours: 2,
    utilizationByRange: {
      '7d': { label: 'Last 7 Days', periodLabel: 'This Week', chartSubLabel: 'Daily', activeHours: 2.0, uptimePct: 100, data: [{ label: 'Today', hoursActive: 2, cyclesRun: 5 }] }
    },
    downtimeRecords: [],
    maintenanceRecords: [{ id: "MNT-2026-08-18", date: "2026-08-18", type: "Commissioning IQ/OQ/PQ", engineer: "S. Patel (ENG-08)", status: "PASSED", docName: "Install_Cert.pdf" }]
  },
  {
    id: "ABIOT-SAFE-08",
    name: "Sterilizer 08 (Cardiology)",
    location: "Block A - Level 4 (Cardiology)",
    department: "Cardiology Unit",
    status: "Connection Lost",
    lastPacketReceived: "6 mins ago",
    currentPhaseStep: 8,
    predictedPhaseStep: 11,
    phase: "8. Negative Pressure",
    predictedPhase: "11. VHP Injection",
    temperature: 55.0,
    targetTemp: 60.0,
    humidity: 40.0,
    pressure: -10.0,
    h2o2: 100,
    residualH2o2: 0.5,
    cycleTimeRemaining: "25 min (Predicted)",
    progressPct: 40,
    predictedProgressPct: 65,
    operator: "Amit Das (OP-120)",
    wasteCategory: "Yellow Bag (Infectious)",
    currentBagId: "BAG-2026-8850",
    cassetteId: "CASS-H2O2-10",
    activeAlarmsCount: 0,
    serialNumber: "SN-E-SAFE-2025-0150E",
    procurementDate: "2025-10-01",
    installationDate: "2025-11-01",
    firmwareVersion: "v3.4.12-secure",
    softwareVersion: "SmartTrace-Edge-v2.8",
    hospitalId: "HOSP-APOLLO-BG",
    gpsCoordinates: "12.9719° N, 77.5941° E",
    pumpHealth: 88,
    fanHealth: 90,
    motorHealth: 85,
    doorCycles: 1520,
    ...
    connectivityMode: "Wi-Fi (Reconnecting)",
    signalStrength: "Searching...",
    hardwareKeyId: "ATECC608A-ECDSA-KEY-0822",
    latestHashSignature: "Pending Cycle Sync",
    totalOperatingHours: 3200,
    utilizationByRange: {
      '7d': { label: 'Last 7 Days', periodLabel: 'This Week', chartSubLabel: 'Daily', activeHours: 85.0, uptimePct: 90, data: [{ label: 'Mon', hoursActive: 12, cyclesRun: 15 }, { label: 'Tue', hoursActive: 14, cyclesRun: 18 }] }
    },
    downtimeRecords: [],
    maintenanceRecords: [{ id: "MNT-2026-05", date: "2026-05-20", type: "Biannual Service", engineer: "M. Verma (ENG-14)", status: "PASSED", docName: "Biannual_Cert.pdf" }]
  },
  {
    id: "ABIOT-SAFE-09",
    name: "Sterilizer 09 (Pathology Lab)",
    location: "Block C - Ground Floor",
    department: "Pathology & Micro",
    status: "Maintenance",
    lastPacketReceived: "2 mins ago",
    currentPhaseStep: 1,
    phase: "Diagnostics Mode",
    temperature: 25.0,
    targetTemp: 0.0,
    humidity: 55.0,
    pressure: 0.0,
    h2o2: 0,
    residualH2o2: 0.0,
    cycleTimeRemaining: "Test Cycle",
    progressPct: 0,
    operator: "S. Patel (ENG-08)",
    wasteCategory: "Test Load",
    currentBagId: "TEST-BAG-01",
    cassetteId: "CASS-TEST",
    activeAlarmsCount: 0,
    serialNumber: "SN-E-SAFE-2024-0020B",
    procurementDate: "2024-05-01",
    installationDate: "2024-06-01",
    firmwareVersion: "v3.2.1",
    softwareVersion: "SmartTrace-Edge-v2.6",
    hospitalId: "HOSP-APOLLO-BG",
    gpsCoordinates: "12.9710° N, 77.5935° E",
    pumpHealth: 75,
    fanHealth: 80,
    motorHealth: 78,
    doorCycles: 4200,
    ...
    connectivityMode: "eSIM Cellular",
    signalStrength: "-75 dBm (Good)",
    hardwareKeyId: "ATECC608A-ECDSA-KEY-0444",
    latestHashSignature: "Test Sync Complete",
    totalOperatingHours: 4500,
    utilizationByRange: {
      '7d': { label: 'Last 7 Days', periodLabel: 'This Week', chartSubLabel: 'Daily', activeHours: 70.0, uptimePct: 80, data: [{ label: 'Mon', hoursActive: 10, cyclesRun: 12 }] }
    },
    downtimeRecords: [{ id: 'DT-2026-08', startTime: '2026-08-18 09:00', duration: 'Ongoing', reason: 'Scheduled Filter Replacement', resolvedBy: 'S. Patel', type: 'Planned' }],
    maintenanceRecords: [{ id: "MNT-2026-02", date: "2026-02-10", type: "Annual Service", engineer: "R. Sharma (ENG-02)", status: "PASSED", docName: "Service_Report.pdf" }]
  },
  {
    id: "ABIOT-SAFE-10",
    name: "Sterilizer 10 (Pediatrics)",
    location: "Block A - Level 2",
    department: "Pediatrics",
    status: "Running",
    lastPacketReceived: "Just now",
    currentPhaseStep: 12,
    phase: "12. H2O2 Dwell Phase",
    temperature: 50.0,
    targetTemp: 50.0,
    humidity: 20.0,
    pressure: -15.0,
    h2o2: 120,
    residualH2o2: 1.0,
    cycleTimeRemaining: "18 min",
    progressPct: 60,
    operator: "M. Kumar",
    wasteCategory: "Red Bag",
    currentBagId: "BAG-CRADLE-01",
    cassetteId: "CASS-CRADLE-1",
    activeAlarmsCount: 0,
    serialNumber: "SN-E-SAFE-2025-CRAD1",
    procurementDate: "2025-01-10",
    installationDate: "2025-02-12",
    firmwareVersion: "v3.1.2",
    softwareVersion: "SmartTrace-Edge-v2.1",
    hospitalId: "HOSP-APOLLO-CRADLE-JYN",
    gpsCoordinates: "12.9240° N, 77.5800° E",
    pumpHealth: 92,
    fanHealth: 95,
    motorHealth: 90,
    doorCycles: 850,
    ...
    connectivityMode: "Wi-Fi (Active)",
    signalStrength: "-60 dBm (Good)",
    hardwareKeyId: "ATECC608A-ECDSA-CRAD1",
    latestHashSignature: "Pending Cycle Sync",
    totalOperatingHours: 1200,
    utilizationByRange: null,
    downtimeRecords: [],
    maintenanceRecords: []
  },
  {
    id: "ABIOT-SAFE-11",
    name: "Sterilizer 11 (Outpatient)",
    location: "Ground Floor Lab",
    department: "Pathology",
    status: "Idle",
    lastPacketReceived: "1 min ago",
    currentPhaseStep: 1,
    phase: "1. Ready for Load",
    temperature: 30.0,
    targetTemp: 45.0,
    ...
    cassetteId: "N/A",
    activeAlarmsCount: 0,
    serialNumber: "SN-E-SAFE-2025-CLIN1",
    procurementDate: "2025-05-15",
    installationDate: "2025-06-20",
    firmwareVersion: "v3.1.2",
    softwareVersion: "SmartTrace-Edge-v2.1",
    hospitalId: "HOSP-APOLLO-CLINIC-KOR",
    gpsCoordinates: "12.9350° N, 77.6150° E",
    pumpHealth: 90,
    fanHealth: 88,
    motorHealth: 85,
    doorCycles: 420,
    ...
    connectivityMode: "Wi-Fi (Active)",
    signalStrength: "-50 dBm (Excellent)",
    hardwareKeyId: "ATECC608A-ECDSA-CLIN1",
    latestHashSignature: "Pending Cycle Sync",
...
export const AUDIT_TRAIL_LOGS = [
  ...
  {
    cycleId: "CYC-2026-09406",
    machineId: "ABIOT-SAFE-10",
    barcode: "BMW-98124200",
    bagId: "BAG-2026-8799",
    bagCategory: "Red Bag (Contaminated Plastic)",
    cassetteId: "CASS-H2O2-02",
    department: "Pediatrics",
    operator: "M. Kumar",
    startTime: "2026-08-06 08:00",
    endTime: "2026-08-06 08:45",
    duration: "45 min",
    aiResult: "Bag Intact (99.1% Conf)",
    cpcbStatus: "PASSED",
    hashChain: "f82b7711f77b4f7a080dabe7498e7c8ec251441ea6fd7861925d6b9d77d86355",
    signatureVerified: true,
    downloadable: true
  },
  {
    cycleId: "CYC-2026-09405",
    machineId: "ABIOT-SAFE-11",
    barcode: "BMW-98124150",
    bagId: "BAG-2026-8750",
    bagCategory: "Yellow Bag (Infectious)",
    cassetteId: "CASS-H2O2-01",
    department: "Pathology",
    operator: "K. Singh",
    startTime: "2026-08-06 07:15",
    endTime: "2026-08-06 08:00",
    duration: "45 min",
    aiResult: "Bag Intact (98.9% Conf)",
    cpcbStatus: "PASSED",
    hashChain: "a32b7711f77b4f7a080dabe7498e7c8ec251441ea6fd7861925d6b9d77d86355",
    signatureVerified: true,
    downloadable: true
  }
];
...
export const REGIONAL_HOSPITALS = [
  ...
  {
    id: 'HOSP-APOLLO-CRADLE-JYN',
    name: 'Apollo Cradle & Children’s Hospital',
    groupId: 'GRP-APOLLO',
    locality: 'Jayanagar 5th Block (8 km)',
    cpcbLicenseNo: 'CPCB-BMW-2025-KA-3321',
    deviceCount: 2,
    runningCount: 2,
    alarmCount: 0,
    idleCount: 0,
    ...
    monthlyWasteKg: 4200,
    contactPerson: 'Dr. S. Nair',
    phone: '+91 80 4350 0000',
    lastServiced: '2026-08-01',
    status: 'Operational'
  },
  {
    id: 'HOSP-APOLLO-CLINIC-KOR',
    name: 'Apollo Clinic Koramangala',
    groupId: 'GRP-APOLLO',
    locality: 'Koramangala 6th Block (15 km)',
    cpcbLicenseNo: 'CPCB-BMW-2024-KA-1122',
    deviceCount: 1,
    runningCount: 0,
    alarmCount: 0,
    idleCount: 1,
