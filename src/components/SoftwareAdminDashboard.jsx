    ...
    <div className="space-y-5">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-3">
          <div>
            <div className="flex items-center space-x-2 mb-1.5">
              <span className="text-[10px] font-extrabold px-2.5 py-0.5  bg-purple-100 text-purple-800 dark:bg-purple-950 dark:text-purple-300 border border-purple-300 uppercase tracking-wider flex items-center gap-1">
      ...
      <div className={`p-5 border ${
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <span className="text-xs font-bold px-2.5 py-1  bg-purple-100 text-purple-800 dark:bg-purple-950 dark:text-purple-300">
            ...
            >
              <div>
                <div className="flex items-center space-x-2 mb-1">
                  ...
                  <span className="text-[10px] px-2 py-0.5  bg-slate-200 dark:bg-slate-800 text-slate-600 dark:text-slate-400 font-medium">
                    {t.category}
                  </span>
                </div>
              ...
              <div className="flex items-center space-x-3 shrink-0">
                <span className={`px-2.5 py-1  text-[10px] font-extrabold ${
                  t.status === 'RESOLVED'
                ...
                {t.status !== 'RESOLVED' && (
                  <button
                    ...
                    className="px-3 py-1.5 bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-xs  flex items-center space-x-1 "
                  >
